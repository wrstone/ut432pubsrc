/*=============================================================================
	XMesaGLFuncs.h: OpenGL/glX function-declaration macros.
...
// glX
GL_PROC(_GL,XVisualInfo*,glXChooseVisual,(Display*, int, int*))
GL_PROC(_GL,GLXContext,glXCreateContext,(Display*, XVisualInfo*, GLXContext, Bool))
GL_PROC(_GL,Bool,glXDestroyContext,(Display*, GLXContext))
GL_PROC(_GL,Bool,glXMakeCurrent,(Display*, GLXDrawable, GLXContext))
GL_PROC(_GL,Bool,glXQueryVersion,(Display*, INT*, INT*))
GL_PROC(_GL,void,glXSwapBuffers,(Display*, GLXDrawable))
GL_PROC(_GL,int,glXGetConfig,(Display*, XVisualInfo*, int, int*))
