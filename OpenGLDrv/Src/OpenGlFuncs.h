/*=============================================================================
	OpenGlFuncs.h: OpenGL function-declaration macros, to enable dynamic linking
	to OpenGL32.dll or a minidriver such as 3dfxgl.dll.

	Copyright 1997-1999 Epic Games, Inc. All Rights Reserved.

	Format:
	GLDEF(
		Optional (0=required, 1=optional, 2=optional extension),
		Return type,
		Function name,
		(parameters))
